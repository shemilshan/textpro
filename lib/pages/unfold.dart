...
class unfold extends StatefulWidget {
  const unfold({super.key});

  @override
  State<unfold> createState() => _unfoldState();
}

class _unfoldState extends State<unfold> {
  ...
  Future<void>generate()async{
    ...
    final prompt="Slot a word into other words or phrases. word:${txt.text}.give only one";
        ...
        padding: EdgeInsets.only(top: 45,left: 20,right: 20),
          ...
          child: ListView(
            children: [Column(
              ...
              children: [
                Text("Unfold",style: GoogleFonts.hammersmithOne(color:Colors.white,fontSize:40)),
                Padding(
                  padding: const EdgeInsets.only(top: 5),
                  child: Text("Slot a word into other words or phrases.",style: GoogleFonts.hammersmithOne(color:Colors.white,fontSize:18)),
                ),
                Padding(
