...
class acronym extends StatefulWidget {
  const acronym({super.key});

  @override
  State<acronym> createState() => _acronymState();
}

class _acronymState extends State<acronym> {
  ...
  Future<void>generate()async{
    ...
    final prompt="Create an acronym using the letters of a word: ${txt.text}.give in single line";
        ...
        padding: EdgeInsets.only(top: 45,left: 20,right: 20),
          ...
          child: ListView(
            children: [Column(
              ...
              children: [
                Text("Acronym",style: GoogleFonts.hammersmithOne(color:Colors.white,fontSize:40)),
                Padding(
                  padding: const EdgeInsets.only(top: 5),
                  child: Text("Create an acronym using the letters of a word.",style: GoogleFonts.hammersmithOne(color:Colors.white,fontSize:18)),
                ),
                Padding(
